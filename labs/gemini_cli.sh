export GOOGLE_CLOUD_PROJECT=qwiklabs-gcp-03-69f0deb16be7
export GOOGLE_CLOUD_LOCATION=us-east4
export GEMINI_MODEL=gemini-2.5-flash
echo "export GOOGLE_CLOUD_PROJECT=qwiklabs-gcp-03-69f0deb16be7" >> ~/.bashrc
echo "export GOOGLE_CLOUD_LOCATION=us-east4" >> ~/.bashrc
